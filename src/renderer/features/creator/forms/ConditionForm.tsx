...
export default function ConditionForm({ onSuccess }: Props): React.JSX.Element {
  ...
  return (
    <form data-live-demo-form="condition" noValidate onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <Button data-live-demo-submit="condition" type="submit" disabled={status === 'loading'} variant={status === 'success' ? 'outline' : 'default'} className="w-full">
