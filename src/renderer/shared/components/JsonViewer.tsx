...
export default function JsonViewer({
  ...
  return (
    <div className={cn('flex w-full flex-col overflow-hidden rounded-lg border border-border bg-background shadow-sm', className)}>
      <div className={cn('flex items-center justify-between border-b px-3 py-2 transition-colors', headerClasses)}>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Button
            ...
            variant="ghost"
            size="icon"
            className="h-6 w-6 text-muted-foreground hover:bg-background/70 hover:text-foreground"
            onClick={handleCopy}
      ...
      {!collapsed && (
        <div
          className={cn(
            ...
            fillHeight ? 'min-h-0 flex-1' : 'max-h-[500px]',
            contentClasses
          )}
        >
          {viewMode === 'summary' ? (
